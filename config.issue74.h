...
//            name        port   pwm  kP   kI  kD   Watts, t_dead
DEFINE_HEATER(extruder,   PB3,   1,  32,   8,  192,  21,     9  )
DEFINE_HEATER(bed,        PB4,   1,  2.34, -20,  0,   150,    10  )
// DEFINE_HEATER(fan,     PINB4, 0,  10,  0.5,  0,  0.21,     0.5)
// DEFINE_HEATER(chamber, PIND7, 1,  24,  0.5,  0,  40,    40  )
// DEFINE_HEATER(motor,   PIND6, 1,  24,  0.5,  0,  100,     0  )
